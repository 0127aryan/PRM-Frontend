...
/** @param {EmployeeStatus} status @param {string} [accountStatus] */
export function employeeStatusLabel(status, accountStatus) {
...
/** @param {EmployeeStatus} status @param {string} [accountStatus] */
export function employeeStatusClass(status, accountStatus) {
