...
import { FolderKanban, LogOut, Sparkles, UserPlus, Users } from 'lucide-react';
...
const NAV = [
  {
    ...
    icon: FolderKanban,
    match: (path) => path.startsWith('/manager/projects'),
  },
  {
    href: '/manager/employees',
    label: 'Employee management',
    icon: Users,
    match: (path) => path.startsWith('/manager/employees'),
  },
  {
    href: '/manager/allocate',
    label: 'Allocate resource',
    icon: UserPlus,
    match: (path) => path.startsWith('/manager/allocate'),
  },
  {
    href: '/manager/assistant',
    label: 'AI assistant',
    icon: Sparkles,
    match: (path) => path.startsWith('/manager/assistant'),
  },
];
